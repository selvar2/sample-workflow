...
def process_incident_route(incident_number: str):
    ...
    try:
        ...
        if incident_type == IncidentType.SECURITY_GROUP:
            ...
            # Note: process_security_group_incident returns True/False
            success = process_security_group_incident(incident_number)
            result = {
                "incident_number": incident_number,
                "success": success,
                "message": "Security Group operation completed successfully" if success else "Security Group operation failed",
