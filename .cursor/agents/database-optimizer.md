...
description: Database performance specialist. Use for query optimization, index design, execution plan analysis, and achieving sub-second query performance.
---
