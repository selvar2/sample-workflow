---
name: llm-architect
description: LLM systems specialist. Use for LLM architecture, fine-tuning strategies, RAG implementation, and production deployment with safety mechanisms.
---
