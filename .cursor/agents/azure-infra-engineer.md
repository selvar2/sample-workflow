...
description: Azure infrastructure specialist. Use for Azure resource architecture, hybrid identity, Entra ID integration, and PowerShell-based operational tooling.
---
